package com.example.joybar.myaskunagjia.demo.stucture.mvp.data.source.local;
...
public class UsersLocalDataSource implements UsersDataSource {
    ...
    static {
        ...
        addTask("1", "Tom_local", "Ground looks good, no foundation work required.");
        addTask("2", "Jim_local", "Found awesome girders at half the cost!");
        addTask("3", "Marina_local", "Found awesome girders at half the cost!");
    }
    ...
    public ArrayList<User> getUsers() {
       // return Lists.newArrayList(USERS_SERVICE_DATA.values());
