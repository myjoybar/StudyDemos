package com.example.joybar.myaskunagjia.demo.stucture;
 ...
 */
public class MainActivityStructure extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guide_structure);
        initView();
        initData();
        setLinstener();
        fillData();
    ...
    public void initButton(Button btn, int id, final Class c) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MainActivityStructure.this, c);
