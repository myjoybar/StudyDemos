package com.example.joybar.myaskunagjia.demo.animation;
...
public class MainActivityGuide extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guide_anni);
        initView();
        initData();
        setLinstener();
        fillData();
    ...
    protected void initData() {
        initButton(btn,R.id.btn,com.example.joybar.myaskunagjia.demo.animation.demo1.MainActivity.class);
        initButton(btn2,R.id.btn2,com.example.joybar.myaskunagjia.demo.animation.ani2.MainActivity.class);
        initButton(btn3,R.id.btn3,com.example.joybar.myaskunagjia.demo.animation.ani3.MainActivity.class);
        initButton(btn4,R.id.btn4,com.example.joybar.myaskunagjia.demo.animation.ani4.MainActivity.class);
    }
