package com.example.joybar.myaskunagjia.demo.otherfunc;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guide_other_func);
        initView();
        initData();
        setLinstener();
        fillData();
    ...
    protected void setLinstener() {
        initButton(btn1, R.id.btn1, com.example.joybar.myaskunagjia.demo.otherfunc.startotherapp.MainActivity.class);
