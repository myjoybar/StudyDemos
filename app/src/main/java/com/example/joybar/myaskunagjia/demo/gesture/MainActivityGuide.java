...
public class MainActivityGuide extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guide_gesture);
        initView();
        initData();
        setLinstener();
        fillData();
    ...
    protected void setLinstener() {
        initButton(btn, R.id.btn, com.example.joybar.myaskunagjia.demo.gesture.MainActivity.class);
        initButton(btn2,R.id.btn2,com.example.joybar.myaskunagjia.demo.gesture.GestureTest.class);
        initButton(btn3,R.id.btn3,com.example.joybar.myaskunagjia.demo.gesture.gesture3.MainActivity.class);
        initButton(btn4,R.id.btn4,com.example.joybar.myaskunagjia.demo.gesture.gesture4.MainActivity.class);
    }
