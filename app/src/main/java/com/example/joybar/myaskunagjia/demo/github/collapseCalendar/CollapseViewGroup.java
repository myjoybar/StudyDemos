 ...
 */
public class CollapseViewGroup extends RelativeLayout implements View.OnTouchListener,View.OnClickListener {
    ...
    public CollapseViewGroup(Context context) {
        super(context);
        init(context);
    }
    ...
    public CollapseViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
