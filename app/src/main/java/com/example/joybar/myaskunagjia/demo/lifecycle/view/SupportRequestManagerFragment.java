package com.example.joybar.myaskunagjia.demo.lifecycle.view;
...
import com.example.joybar.myaskunagjia.demo.lifecycle.RequestManagerRetriever;
import com.example.joybar.myaskunagjia.demo.lifecycle.interfaces.RequestManagerTreeNode;
import com.example.joybar.myaskunagjia.demo.lifecycle.manager.ActivityFragmentLifecycle;
...
public class SupportRequestManagerFragment extends Fragment {
	...
	public void onStart() {
		...
		L1.d(TAG,"SupportRequestManagerFragment--isStop");
		super.onStart();
		lifecycle.onStart();
	}
	...
	@Override
	public void onStop() {
		L1.d(TAG,"SupportRequestManagerFragment--onStop");
		super.onStop();
		lifecycle.onStop();
	}
	...
	public void onDestroy() {
		L1.d(TAG,"SupportRequestManagerFragment--onDestroy");
		super.onDestroy();
		lifecycle.onDestroy();
	}
	...
	public void onLowMemory() {
		L1.d(TAG,"SupportRequestManagerFragment--onLowMemory");
		super.onLowMemory();
