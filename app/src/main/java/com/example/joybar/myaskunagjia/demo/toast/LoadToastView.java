...
public class LoadToastView extends View {
    ...
    private void init(){
       ...
       spinnerRect = new RectF();
        ...
        iconBounds = new Rect(TOAST_HEIGHT + MAX_TEXT_WIDTH - padding, padding,
                TOAST_HEIGHT + MAX_TEXT_WIDTH - padding + IMAGE_WIDTH, IMAGE_WIDTH + padding);
//lo   //loadicon= getResources().getDrawable(R.mipmap.ic_launcher);
