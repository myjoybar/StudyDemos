package com.example.joybar.myaskunagjia.demo.mvp;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guide_mvp);
        initView();
        initData();
        setLinstener();
        fillData();
    ...
    protected void setLinstener() {
     //   initButton(btn, R.id.btn, com.example.joybar.myaskunagjia.demo.webview.MainActivity.class);
        initButton(btn2,R.id.btn2,com.example.joybar.myaskunagjia.demo.mvp.MVP2.View.MainActivity.class);
