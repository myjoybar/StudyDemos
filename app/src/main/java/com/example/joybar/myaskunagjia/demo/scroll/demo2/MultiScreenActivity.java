package com.example.joybar.myaskunagjia.demo.scroll.demo2;
        ...
        switch (v.getId()) {
            case R.id.bt_scrollLeft:
                if(curscreen > 0) {  //防止屏幕越界
                    curscreen -- ;
                    Toast.makeText(MultiScreenActivity.this, "第" +(curscreen+1) + "屏", Toast.LENGTH_LONG).show();
                }
                else
                    Toast.makeText(MultiScreenActivity.this, "当前已是第一屏",Toast.LENGTH_LONG).show();
            ...
            case R.id.bt_scrollRight:
                if (curscreen < 2 ){ //防止屏幕越界
                    ...
                    Toast.makeText(MultiScreenActivity.this, "当前已是最后一屏",Toast.LENGTH_LONG).show();
                mulTiViewGroup.scrollTo(curscreen * screenWidth, 0);
                break;
        }
    }
