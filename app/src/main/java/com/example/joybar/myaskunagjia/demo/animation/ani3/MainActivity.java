package com.example.joybar.myaskunagjia.demo.animation.ani3;
...
public class MainActivity extends BaseActivity {
    ...
    private void initShowAnim1(){
        ObjectAnimator fViewScaleXAnim=ObjectAnimator.ofFloat(lv,"scaleX",1.0f,0.8f);
        fViewScaleXAnim.setDuration(350);
        ObjectAnimator fViewScaleYAnim=ObjectAnimator.ofFloat(lv,"scaleY",1.0f,0.8f);
        fViewScaleYAnim.setDuration(350);
        ObjectAnimator fViewAlphaAnim=ObjectAnimator.ofFloat(lv,"alpha",1.0f,0.5f);
        fViewAlphaAnim.setDuration(350);


        //旋转动画--关键
        ObjectAnimator fViewRotationXAnim = ObjectAnimator.ofFloat(lv, "rotationX", 0f, 10f);
        fViewRotationXAnim.setDuration(200);
        ObjectAnimator fViewResumeAnim = ObjectAnimator.ofFloat(lv, "rotationX", 10f, 0f);
        fViewResumeAnim.setDuration(150);
        fViewResumeAnim.setStartDelay(200);
       ...
       ObjectAnimator fViewTransYAnim = ObjectAnimator.ofFloat(lv, "translationY", 0, -0.1f* lv.getHeight());
        //    ObjectAnimator fViewTransYAnim = ObjectAnimator.ofFloat(lv, "translationY", 0, -secondView.getHeight());
        fViewTransYAnim.setDuration(350);
...
//        fViewResumeAnim.setStartDelay(200);
    ...
    private void initHideAnim2(){
        ObjectAnimator fViewScaleXAnim=ObjectAnimator.ofFloat(lv,"scaleX",0.8f,1.0f);
        fViewScaleXAnim.setDuration(350);
        ObjectAnimator fViewScaleYAnim=ObjectAnimator.ofFloat(lv,"scaleY",0.8f,1.0f);
        fViewScaleYAnim.setDuration(350);
        ObjectAnimator fViewAlphaAnim=ObjectAnimator.ofFloat(lv,"alpha",0.5f,1.0f);
        fViewAlphaAnim.setDuration(350);
        ...
        ObjectAnimator fViewTransYAnim = ObjectAnimator.ofFloat(lv, "translationY", -0.1f* lv.getHeight(),0);
        fViewTransYAnim.setDuration(350);
    ...
    private void initHideAnim3(){
        ...
        ObjectAnimator fViewTransYAnim = ObjectAnimator.ofFloat(lv, "translationY", -secondView.getHeight(),0);
        fViewTransYAnim.setDuration(350);
