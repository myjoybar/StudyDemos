...
public class ActivityManager {
	...
	private ClassLoader createDexClassLoader(String apkPath) {
		...
		DexClassLoader dexClassLoader = new DexClassLoader(apkPath, dexOptDir.getAbsolutePath(), null, mContext.getClassLoader());
	 ...
	 * @param apkPath
	 */
	public void startActivity1(String pluginActivityClzz, String apkPath,Context context) {
